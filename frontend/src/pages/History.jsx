...
Los colores rojo, blanco y negro, tienen su fundamento. Se eligió al rojo por el socialismo, al cual estaban vinculados todos los miembros fundadores. El blanco se escogió por la pureza de sus miembros y el negro por la cercanía del Cementerio de la Chacarita, que a su vez dio origen al apodo de "Funebrero".</p>
      </div>

      <div className="decadas">
        <p className='p-titulo'>Decadas de 1920, 1930 y 1940</p>
        <p className='p-texto'>Tras varios amistosos, en 1921 participó de una liga independiente, la «Asociación Deportiva Belgrano», y en 1921 se inscribió en las divisiones inferiores de la Asociación Argentina de Football, la institución rectora del fútbol amateur argentino avalada por la FIFA, ocupando el tercer puesto en su primer campeonato.
...
En 1927 llegó al primer puesto del campeonato invicto con cuatro empates. Fusionado en el fútbol porteño las Asociaciones Argentina y Amateurs Chacarita mantuvo buenas campañas hasta los sucesos de 1930 que iniciarían la era del profesionalismo en el país.
...
En ese período destacarían entre otros jugadores Enrique Esquide, Roberto Moreno, José Coll, Humberto A. De Luca, Roberto E. Dutruel, Carlos Spinelli y los delanteros Francisco Campana y Marcos Busico.</p>
      </div>

      <div className="siguientes">
        <p className='p-titulo'>Años siguientes</p>
        <p className='p-texto'>Entre 1956 y 1959 volvió a actuar en la segunda división. El 5 de diciembre de 1959 obtuvo el ascenso al vencer a Talleres de Remedios de Escalada. Tras evitar a duras penas un nuevo descenso en 1967, se hizo cargo del plantel Argentino Geronazzo quien reorganizó el equipo incorporando a Ángel Alberto Marcos, Jorge Alberto Gómez, Alberto Raúl Poncio, Ángel Hugo Bargas y Franco Frassoldati, Leonardo Luis Recúpero, Horacio Ricardo Neumann y en la valla Jorge Eliseo Petrocelli. Entre sus suplentes se encontraban Juan Antonio Gómez Voglino y Carlos María García Cambón, y el arquero Bernabé Adolfo Palacios.</p>
      </div>
      <div className="campeonato">
        <p className='p-titulo'>El campeonato de 1969</p>
        <p className='p-texto'>En 1969 Federico Pizarro reemplazó a Argentino Geronazzo manteniendo la base del equipo, incorporándose al zaguero de Boca Abel Jorge Pérez, al volante de Newell's Juan Carlos Puntorero y al delantero de Estudiantes de La Plata Rodolfo Orife.
