...
const plans = [
  {
    ...
    name: "Plan Básico",
    price: 8000,
    description: ["Acceso a 1 actividad.", "Carnet digital."],
  },
  {
    id: "completo",
    name: "Plan Completo",
  ...
  return (
    <>
      <div className="formGroup">
        <label className="formLabel" htmlFor="dni">
          DNI
        </label>
        <input
          id="dni"
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="apellido">
          Apellido
        </label>
        <input
          id="apellido"
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="fechaNacimiento">
          Fecha de Nacimiento
        </label>
        <input
          id="fechaNacimiento"
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="direccion">
          Dirección
        </label>
        <input
          id="direccion"
          autoComplete="off"
          className="formInput"
          placeholder="Calle y altura del domicilio"
          type="text"
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="localidad">
          Localidad
        </label>
        <input
          id="localidad"
...
const Step2 = ({
  ...
  return (
    <>
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="passConfirm">
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="securityQuestion">
      ...
      <div className="formGroup">
        <label className="formLabel" htmlFor="securityAnswer">
  ...
  return (
    <>
      <div className="newContainer">
        ...
        <p>
          Por favor, confirmá que toda la información ingresada sea correcta.
        </p>
        <div className="newUserContainer">
          <ul className="newUserDetail">
            ...
            <li>
              ...
              <br /> {data.address.street}, {data.address.city}
            </li>
          </ul>
          <div className="planDetail">
            ...
            <p>
              <strong>Plan: </strong>&nbsp;
              {planSeleccionado ? planSeleccionado.name : "No seleccionado."}
            </p>
            <p>
              <strong>Precio: </strong>&nbsp;
              {planSeleccionado
                ? `${"$" + planSeleccionado.price}`
                : "No seleccionado."}
            </p>
            <p>
              <strong>Medio de Pago: </strong>&nbsp;Sede
            </p>
          </div>
        </div>
      </div>
    ...
    <>
      ...
      <div className="formContainer">
        ...
        <div className="formStep">
          <button
            className={`stepButton ${step === 1 ? "active" : ""}`}
            onClick={() => goToStep(1)}
          >
            1. Datos Personales
          </button>
          <button
            className={`stepButton ${step === 2 ? "active" : ""}`}
          ...
          <button
            className={`stepButton ${step === 3 ? "active" : ""}`}
          ...
          <button
            className={`stepButton ${step === 4 ? "active" : ""}`}
            disabled={
              !isStep3Valid() || !isStep2Valid() || !isStep1Valid() || isLoading
            }
            onClick={() => goToStep(4)}
          >
            4. Revisión
